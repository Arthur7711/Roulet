...
export default function NumbersBord({checkColor,isClicked}) {
  ...
  // const isClickedOdd = (num) => {
  //   console.log("clicked", "color:black", num);
  //   localStorage.setItem("selected", num);
  // };

  // const isClickedeven = (num) => {
  //   localStorage.setItem("selected", num);
  //   console.log("clicked", "color:red", num);
  // };
